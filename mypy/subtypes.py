...
def _is_subtype(
    ...
    *,
    ...
    if (
        ...
        return True
    elif isinstance(right, AnnotatedType) and not isinstance(left, AnnotatedType):
        return False

    elif not isinstance(right, AnnotatedType) and isinstance(left, AnnotatedType):
        return False
