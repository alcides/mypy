...
class TypeTriggersVisitor(TypeVisitor[List[str]]):
    ...
    def visit_annotated_type(self, t: AnnotatedType) -> List[str]:
        triggers = []
        triggers.extend(self.get_type_triggers(t.base_type))
        # triggers.extend(self.get_type_triggers(t.metadata))
        return triggers
